...
class CountNumberOfOccurencesOfAnagrams {

    func solve(){
        print(countNumberOfOccurencesOfAnagrams( "aabaabaa", "aaba"))
    }
    
    private func countNumberOfOccurencesOfAnagrams(_ text: String,_ pattern: String) -> Int {
...
let obj = CountNumberOfOccurencesOfAnagrams()
obj.solve()
